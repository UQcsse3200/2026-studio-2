...
public class MovingPlatformComponent extends PlatformGrappleComponent {
    ...
    //private static final Logger logger = LoggerFactory.getLogger(com.csse3200.game.physics.components.PhysicsMovementComponent.class);
     ...
     */
    public MovingPlatformComponent(int grappleSides, Vector2 leftTarget, Vector2 rightTarget, Vector2 maxSpeed) {
        super(grappleSides);
