...
class ArrowSelectionComponentTest {
  ...
  @Test
  void standardArrowShouldFireOnlyOnRelease() {
    ArrowSelectionComponent component = new ArrowSelectionComponent();
    Entity player = createPlayerWithSelector(component);
    ...
    assertNull(attackDirection.get()); // nothing fires on press
  ...
  @Test
  void grappleArrowShouldFireImmediatelyOnPressAndReleaseOnStop() {
    ArrowSelectionComponent component = new ArrowSelectionComponent();
    Entity player = createPlayerWithSelector(component);
